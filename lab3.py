...
def caesar_cipher(text, shift):
    ...
    for char in text:
        ...
        if char.isalpha():
            # Запоминаем, был ли символ изначально в верхнем регистре
            is_upper = char.isupper()

            # Приводим символ к нижнему регистру для правильного сдвига
            char = char.lower()

            # Вычисляем сдвинутый символ
            shifted_char = chr(((ord(char) - ord('a') + shift) % 26) + ord('a'))

            # Если изначально символ был в верхнем регистре, переводим сдвинутый символ в верхний регистр
            if is_upper:
                shifted_char = shifted_char.upper()

            # Добавляем сдвинутый символ к зашифрованному тексту
...
# Запрашиваем у пользователя ввод и сдвиг
user_input = input("Введите строку: ")
shift = int(input("Введите сдвиг (целое число): ")

# Вызываем функцию для шифрования и выводим зашифрованный текст
